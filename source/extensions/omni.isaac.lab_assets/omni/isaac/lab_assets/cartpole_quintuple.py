...
CARTPOLE_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path="C:/Users/Shadow/cartpole_quintuple.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "pole_to_pole_to_pole_to_pole_to_pole": 0.0,
        }
    ),
    actuators={
        ...
        "pole_to_pole_to_pole_to_pole_to_pole": ImplicitActuatorCfg(
            joint_names_expr=["pole_to_pole_to_pole_to_pole_to_pole"],
            effort_limit=15.0,
            velocity_limit=100.0,
            stiffness=0.0,
            damping=0.00015,
